                        ...
                        <div class="card-body">
                            ...
                            <form action="property_details.php?Property_ID=<?= $property_id ?>" method="post">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="text" class="form-control" name="Property_ID" value="<?= htmlspecialchars($property['Property_ID']); ?>" disabled></td>
                                            <td><input type="text" class="form-control" name="Landlord_Name" value="<?= htmlspecialchars($property['Landlord_Name'] ?? 'N/A'); ?>" disabled></td>
                                            <td><input type="text" class="form-control" name="Occupant_Name" value="<?= htmlspecialchars($property['Occupant_Name'] ?? 'N/A'); ?>" disabled></td>
                                            <td><input type="text" class="form-control" name="Usage_Type" value="<?= htmlspecialchars($property['Usage_Type'] ?? 'N/A'); ?>" disabled></td>
                                            <td><input type="text" class="form-control" name="Plot_Number" value="<?= htmlspecialchars($property['Plot_Number']); ?>" disabled></td>
                                            <td><input type="text" class="form-control" name="District" value="<?= htmlspecialchars($property['District']); ?>" disabled></td>
                                            <td><input type="text" class="form-control" name="Location" value="<?= htmlspecialchars($property['Location']); ?>" disabled></td>
                                            <td><input type="number" class="form-control" name="Area" value="<?= htmlspecialchars($property['Area']); ?>" disabled></td>
                                            <td><textarea class="form-control" name="Description" disabled><?= htmlspecialchars($property['Description']); ?></textarea></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="mb-3">
                                    <label for="Landlord_Name" class="form-label">Landlord_Name</label>
                                    <input type="text" class="form-control" id="Landlord_Name" name="Landlord_Name" value="<?= htmlspecialchars($tenancy['Landlord_Name']); ?>" disabled required>
                                </div>
