                        ...
                        <div class="card-body">
                            ...
                            <form action="tenancy_details.php?tenancy_id=<?= $tenancy_id ?>" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="property_id" name="property_id" value="<?= htmlspecialchars($tenancy['Property_id']); ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="occupant_id" class="form-label">Occupant ID</label>
                                    <input type="text" class="form-control" id="occupant_id" name="occupant_id" value="<?= htmlspecialchars($tenancy['Occupant_id']); ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="rca" class="form-label">RCA</label>
                                    <input type="text" class="form-control" id="rca" name="rca" value="<?= htmlspecialchars($tenancy['RCA']); ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="monthly_rent" class="form-label">Monthly Rent</label>
                                    <input type="text" class="form-control" id="monthly_rent" name="monthly_rent" value="<?= htmlspecialchars($tenancy['Monthly_rent']); ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="termination_status" class="form-label">Termination Status</label>
                                    <input type="text" class="form-control" id="termination_status" name="termination_status" value="<?= htmlspecialchars($tenancy['Termination_status']); ?>" required>
                                </div>
